        ...
        <div className="education-content">
          ...
          <ul>
            ...
            <li> 
              <div className='project-link'>
                <b>
                  </b><a href="https://kanthanchatbot.ccbp.tech/" target='_blank'>chatbot
                </a>
              </div>
              </li>
              ...
              <div className='project-link'>
                <b>
                  </b><a href="https://todolistkan.ccbp.tech/" target='_blank'>Todo List <span style={{ color: 'black' }}>(NOTE: Can able to save in local)</span> 
                </a>
              </div>
              </li>
              ...
              <div className='project-link'>
                <b>
                  </b><a href="https://kanimogegame.ccbp.tech/" target='_blank'>Imoge Game
                </a>
              </div>
              </li>
              ...
              <div className='project-link'>
                <b>
                  </b><a href="https://speedtypetstkan.ccbp.tech/" target='_blank'>Typing test
                </a>
              </div>
              </li>
              ...
              <div className='project-link'>
                <b>
                  </b><a href="https://kanthanwiki.ccbp.tech/" target='_blank'>wiki search
                </a>
              </div>
              </li>
              ...
              <div className='project-link'>
                <b>
                  </b><a href="https://kanthannumfacts.ccbp.tech/" target='_blank'>Number and tis facts
                </a>
              </div>
              </li>
              ...
              <div className='project-link'>
                <b>
                  </b><a href="https://kangooglesearch.ccbp.tech/" target='_blank'>Google Screen
                </a>
              </div>
              </li>
